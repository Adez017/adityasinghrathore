...
const Hero = () => {
  return (
    <section
      id="home"
      className="flex min-h-[calc(100dvh-4rem)] w-full flex-col justify-center"
    >
      <div className="flex flex-col gap-8">
        <div>
          <h1 className="flex flex-wrap items-end gap-2 text-4xl font-extrabold leading-none tracking-tight md:text-5xl lg:text-6xl">
            Hey, I'm Aditya! 👋
          </h1>
          <span className="mt-1 flex items-center gap-1 text-sm font-normal text-muted-foreground">
